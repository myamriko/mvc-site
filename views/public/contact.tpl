...
{block name=body}
    ...
    <section id="contact-page-form" class="contact_section">
        <div class="container">
            ...
            <div class="estimate_form">
                <div id="contact_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="contact-info">
                                <textarea id="text" class="textarea-height-min" placeholder="Текст повідомлення"></textarea>
                                <div class="icon-bg">
                    ...
                    <div id="btn" class="text-center">
                        <div class="btn sub-button  text-uppercase">
                            <button id="sendFrontContactBtn" class="submit-button mt-5" onclick="send()">Надіслати <i class="fa ico-angle-right" aria-hidden="true"></i></button>
                        </div>
                    </div>
                </div>
            </div>

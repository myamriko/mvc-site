                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="wow fadeIn" data-wow-delay='0.5s'>
                            <h2 class="text-center">Юридична допомога квалiфiкованого юриста</h2>
                                ...
                                <div class="card card-service text-center wow fadeInLeftBig">
                                    <div class="front">
                                        <div class="card-body">
                                            ...
                                            <h3 class="card-title">Сопровождение сделок с недвижимостью</h3>
                                            <p class="card-text">Nullam quis libero in lorem accumsan sodales. Nam vel
                                                nisi
                                                eget.</p>
                                        </div>
                                    </div>
                                    <div class="back"><p class="card-text ml-1 mr-1">Ціна формується в залежності від
                                            складності
                                            справи (питання), від наявності або відсутності необхідних документів,
                                            обставин,
                                            які мають значення для справи і т.д. Сплата послуг адвоката погодинна, та
                                            складає<br> <b>2500 (дві тисячі п’ятсот гривень) година.</b></p>
                                    </div>
                                </div>
                                <div class="card card-service text-center wow fadeInLeftBig">
                                    <div class="front">
                                        <div class="card-body">
                                            ...
                                            <h3 class="card-title">Арбитражные споры</h3>
                                            <p class="card-text">Nullam quis libero in lorem accumsan sodales. Nam vel
                                                nisi
                                                eget.</p>
                                        </div>
                                ...
                                <div class="card card-service text-center wow fadeInRightBig">
                                    <div class="front">
                                        <div class="card-body">
                                            ...
                                            <h3 class="card-title">Уголовное право</h3>
                                            <p class="card-text">Nullam quis libero in lorem accumsan sodales. Nam vel
                                                nisi
                                                eget.</p>
                                        </div>
        ...
        <section class="gtco-testimonials wow fadeIn" data-wow-offset='200'>
            <div class="container">
                ...
                <div class="owl-carousel owl-carousel1 owl-theme">
                    <div>
                        <div class="card text-center"><img class="card-img-top" src="/public/images/customer1.jpg"
                                                           alt="">
                            <div class="card-body">
                                <h5>Lisa Gally <br/>
                    ...
                    <div>
                        <div class="card text-center"><img class="card-img-top" src="/public/images/customer2.jpg"
                                                           alt="">
                            <div class="card-body">
                                <h5>Missy Limana<br/>
                                    <span> Project Manager </span></h5>
                    ...
                    <div>
                        <div class="card text-center"><img class="card-img-top" src="/public/images/customer3.jpg"
                                                           alt="">
                            <div class="card-body">
                                <h5>Aana Brown<br/>
                                    <span> Project Manager </span></h5>
                ...
                <div class="row">
                    <div class="media col-md-6 col-lg-4 wow fadeIn">
                        ...
                        <div class="media-body">
                            ...
                            Aliquam a nisl pulvinar, hendrerit arcu sed, dapibus velit. Duis ac quam id sapien
                            vestibulum
                    ...
                    <div class="media col-md-6 col-lg-4 wow fadeIn">
                        <div class="oval mr-4"><img class="align-self-start" src="/public/images/easy-to-use.png"
                                                    alt="">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media col-md-6 col-lg-4 wow fadeIn" data-wow-delay='0.2s'>
                        <div class="oval mr-4"><img class="align-self-start" src="/public/images/free-support.png"
                                                    alt="">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media col-md-6 col-lg-4 wow fadeIn" data-wow-delay='0.4s'>
                        <div class="oval mr-4"><img class="align-self-start"
                                                    src="/public/images/effectively-increase.png"
                                                    alt=""></div>
                        <div class="media-body">

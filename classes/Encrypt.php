...
class Encrypt
{
    /**<br/> * Обратимое шифрование методом "Двойного квадрата"
     * (Reversible crypting of "Double square" method)<br/> *
     * @param  String $input   Строка с исходным текстом<br/>
     * @param  bool   $decrypt Флаг для дешифрования<br/>
     * @return String          Строка с результатом Шифрования|Дешифрования<br/> * @author runcore<br/>
     */
    function dsCrypt($input,$decrypt=false) {
        $o = $s1 = $s2 = []; // Arrays for: Output, Square1, Square2
        // формируем базовый массив с набором символов
        $basea = ['?','(','@',';','$','#',"]","&",'*']; // base symbol set
